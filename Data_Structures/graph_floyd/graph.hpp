...
class GraphNode{
    ...
    /**@{*/
         ...
         * @post not isVisited()
         */
        static typename GraphNode<T>::Ref make(size_t label, const T& item){return std::make_shared< GraphNode<T> >(label, item);}
        ...
        */
         ...
         * @post set_item()==item
         */
        void set_item(T const& new_item){_item=new_item;}

        /** @brief Set the flag visited.*/
        void set_visited(bool new_state){_visited=new_state;}
        /** @} */
...
class GraphEdge{
    ...
    /** @{*/
        ...
        * @post first()==u and second()=v
        */
        static Ref make(NodeRef& u, NodeRef& v, E const& item){return std::make_shared< GraphEdge<T, E> > (u, v, item);}
     ...
     */
    NodeRef const & first() const{return _u;}

    /** @brief the start node when a directed edge.
     * @return the start node.
     */
    NodeRef & first(){return _u;}

    /** @brief the end node when a directed edge.
     * @return the end node.
     */
    NodeRef const& second() const{return _v;}

    /** @brief the end node when a directed edge.
     * @return the end node.
     */
    NodeRef & second(){return _v;}
     ...
     * @post getData()==item
     */
    void set_item(E const& item){_item=item;}
...
class WGraph{
    ...
    /**@{*/
        ...
        * @return true if there is not any node.
        */
        bool is_full() const{return _size==_nodes.size();}
        ...
        */
        bool has_current_node() const{return _curr_node<_size;}
